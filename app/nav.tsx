...
import { LayoutGrid, ArrowLeftRight, Zap, ShieldCheck, type LucideIcon } from "lucide-react";
...
const AGENT_ICONS: Record<AgentId, LucideIcon> = { plutus: Zap, helios: ShieldCheck };
...
function buildItems(): NavItem[] {
  return [
    ...
    ...AGENT_IDS.map((id) => ({
      ...
      match: (p: string) => p.startsWith(`/agent/${id}`),
    })),
  ];
}
